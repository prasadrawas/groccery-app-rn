      ...
      <ScrollView className='bg-white'>
        ...
        <View className='flex-row items-center mr-6'>
          <View className='flex-1'>
            <Text className='text-lg text-gray-900 px-4 mt-10 font-[Poppins-SemiBold]'>
              {dummyData.title}
            </Text>
            <View className='flex-row space-x-1'>
              <View className='flex-row space-x-1 px-4'>
                <Text className='text-xs font-[Poppins-Light text-gray-700'>
                  Rating
                </Text>
                <StarIcon size={14} color='green' />
                <Text className='text-xs font-[Poppins-ExtraLight] text-gray-900'>
                  {dummyData.rating}
                </Text>
              </View>
            </View>
            <Text className='px-4 mt-1 text-[12px] font-[Poppins-Light] text-gray-700'>
              {dummyData.weight}
            </Text>
            <Text className='px-4 text-[13px] font-[Poppins-Bold] text-gray-900'>
              {dummyData.price}
            </Text>
          </View>
